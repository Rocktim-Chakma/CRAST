...
base_dir = Path(r"E:\New folder\pypi_malicious_raw_data")
out_file = base_dir.parent / "pypi_malicious_features_v2.csv"
...
print("Total pypi_malicious samples:", len(rows))
